...
app\get("/org", function ($req) {
    ...
    return template\compose("org/list.html", compact('data'), "layout.html");
});
...
app\get("/org/{org_id}/team", function ($req) {
    ...
    return template\compose("org/teams.html", compact('data'), "layout.html");
});
...
app\get("/org/{org_id}/team/add", function ($req) {
    ...
    return template\compose("org/add_team.html", compact('data'), "layout.html");
});
...
app\get("/org/{org_id}/team/{team_id}", function ($req) {
    ...
    return template\compose("org/team_members.html", compact('data'), "layout.html");
});
...
app\get("/org/{org_id}/team/{team_id}/member/{username}/update", function ($req) {
    ...
    return template\compose("org/change_role.html", compact('data'), "layout.html");
});
